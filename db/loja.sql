...
CREATE TABLE IF NOT EXISTS `loja`.`Pedido` (
    ...
    INDEX `fk_Pedido_Colaborador1_idx` (`idColaborador` ASC) VISIBLE,
...
/*Removendo a restrição UNIQUE da coluna 'cpf' na tabela 'Cliente'*/
ALTER TABLE `Cliente`
...
-- *******************************************************
-- * Exemplo de inserção de dados em cada uma das tabelas *
-- *******************************************************

INSERT INTO `loja`.`Cliente` (`cpf`, `nomeCliente`, `numTelefone`, `logradouro`, `cidade`, `complemento`, `numero`, `bairro`, `cep`, `estado`)
VALUES
    ('11122233384', 'João Silva', 1122334455, 'Rua A', 'São Paulo', 'Apto 101', 123, 'Centro', '01234567', 'SP'),
...
INSERT INTO `loja`.`Colaborador` (`cargo`, `dataContratação`)
VALUES
    ('Vendedor', '2010-12-01'),
    ('Vendedor', '2011-01-15'),
    ('Gerente', '2012-03-10'),
...
VALUES
    ('Fantasia Shop 1', 1122334455, 'Rua A', 'São Paulo', 'Loja 101', 123, 'Centro', '01234567', 'SP'),
...
INSERT INTO `loja`.`Produto` (`nomeProd`, `descrição`, `preço`, `quantEstoque`, `idCategoria`)
VALUES
    ('Camiseta Branca Básica', 'Camiseta básica para uso diário', 19.99, 100, 1),
    ('Calça Jeans Slim Fit', 'Calça jeans slim para um look moderno', 39.99, 80, 2),
    ...
    ('Calça Jogger de Moletom', 'Calça jogger de moletom para o dia a dia', 24.99, 60, 2),
    ...
    ('Pijama de Algodão Floral', 'Pijama de algodão floral para dormir confortável', 29.99, 55, 7),
    ...
    ('Calça Pantacourt', 'Calça pantacourt elegante e moderna', 59.99, 40, 2),
    ...
    ('Mochila Feminina Estilosa', 'Mochila feminina estilosa e espaçosa', 49.99, 60, 5),
    ...
    ('Casaco de Lã Longo', 'Casaco de lã longo para o inverno', 79.99, 25, 8),
    ...
    ('Blusa de Algodão Listrada', 'Blusa listrada de algodão', 19.99, 90, 1),
    ('Calça Jeans Flare', 'Calça jeans flare para um visual elegante', 44.99, 75, 2),
    ('Vestido de Verão Floral', 'Vestido floral leve para o verão', 54.99, 55, 3),
    ('Sapato Social Feminino', 'Sapato social feminino para ocasiões formais', 64.99, 40, 4),
    ('Bolsa de Ombro Grande', 'Bolsa de ombro grande e espaçosa', 49.99, 35, 5),
    ('Colar de Pedras Preciosas', 'Colar com pedras preciosas para eventos especiais', 39.99, 60, 6),
    ('Conjunto de Lingerie Renda e Laço', 'Conjunto de lingerie com renda e laço', 29.99, 70, 7),
    ...
    ('Bolsa de Mão Pequena', 'Bolsa de mão pequena e prática', 29.99, 60, 5),
    ('Brinco Ear Cuff', 'Brinco ear cuff moderno e estiloso', 19.99, 80, 6),
    ('Pijama Masculino de Algodão', 'Pijama masculino de algodão para uma boa noite de sono', 39.99, 70, 7),
    ('Blazer Casual', 'Blazer casual para um look profissional', 89.99, 15, 8),
    ('Cardigã de Tricô', 'Cardigã de tricô para os dias mais frescos', 45.99, 50, 9),
...
-- *******************************************************
-- *** Exemplo de modificação dos dados em 5 tabelas ***
-- *******************************************************
...
-- *******************************************************
-- *** Exemplos de exclusão de dados em 5 tabelas ***
-- *******************************************************
...
-- *******************************************************
-- *** Exemplos de criação de de 3 visões (Views) ***
-- *******************************************************

-- *******************************************************
-- *** Exemplos de criação de usuários (pelo menos 2) ***
-- *******************************************************
...
-- *******************************************************
-- * Exemplos de 3 triggers, um para cada evento (inserção, alteração e exclusão) *
-- *******************************************************
